...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create activities
        Activity.objects.create(user=ironman, type='run', duration=30, date='2026-03-09')
        Activity.objects.create(user=batman, type='cycle', duration=45, date='2026-03-09')
        Activity.objects.create(user=captain, type='swim', duration=20, date='2026-03-09')
        Activity.objects.create(user=superman, type='fly', duration=60, date='2026-03-09')
